-- UKHONA PAY: provider-backed payment foundation
-- Run after the base schema. This migration is additive and non-destructive.
...
CREATE INDEX IF NOT EXISTS idx_payment_intents_payer
    ON payment_intents(payer_user_id);

CREATE INDEX IF NOT EXISTS idx_payment_intents_vendor
    ON payment_intents(vendor_id);
...
CREATE INDEX IF NOT EXISTS idx_payment_webhook_received
