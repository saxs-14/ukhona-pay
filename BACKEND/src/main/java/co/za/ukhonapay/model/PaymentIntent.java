...
public class PaymentIntent {
 ...
 @Column(name="redirect_url",length=500) private String redirectUrl;
 ...
 public String getProvider(){return provider;} public void setProvider(String v){provider=v;} public String getProviderPaymentReference(){return providerPaymentReference;} public void setProviderPaymentReference(String v){providerPaymentReference=v;} public String getRedirectUrl(){return redirectUrl;} public void setRedirectUrl(String v){redirectUrl=v;} public String getProviderReference(){return providerReference;} public void setProviderReference(String v){providerReference=v;}
